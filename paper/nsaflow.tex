...
anchors the solution near $X_0$ by construction, this is the expected behaviour
rather than a surprise, and it is the clearest argument for the joint
formulation over factors and loadings that we leave open.
